...
SECRET_KEY = 'django-insecure-l3mdjhrh7!z^g@chagq5(_@2+_+4me+n-y9pm3bg^0-ubu#8r_'
...
CRONJOBS = [
    ('* 0 * * *', 'parser.cron.backup_db', '>> tmp/parser_job.log' )
]
...
DATABASE_ROUTERS = [
    'routers.db_routers.default', 
    'routers.db_routers.parser'
]
